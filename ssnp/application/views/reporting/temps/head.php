...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url() ;?>assets/ui-date/ui.css">

    <link rel="stylesheet" href="<?php echo base_url('assets/amchart/export.css')?>" type="text/css" media="all" />

    <link href="<?php echo base_url('s.JPEG') ?>" rel="shortcut icon" type="image/vnd.microsoft.icon" />
...
<div class="preloader">
    <div class="loader">
        ...
        <p class="loader__label">IOSOFT SOLUTIONS</p>
    </div>
</div>
