...
<header class="topbar">
    ...
    <nav class="navbar top-navbar navbar-expand-md navbar-light" style="background: #51ABF1 !important;">
        <div class="navbar-header"style="background: #51ABF1">
            <a class="navbar-brand" href="<?php echo base_url('bookings/dashboard') ?>" style="margin-top: 5px;">
                <b>
                    <img src="<?php echo base_url(); ?>book.png" alt=" "
